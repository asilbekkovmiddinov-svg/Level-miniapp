...
function promotionsAdminShell() {
    return `<div class="pac-shell">
        <nav class="cpa-admin-menu" aria-label="Admin bo‘limlari"><button class="active">Promotions</button><button onclick="openPage('coin-promotions-admin')">Coin Promotions</button><button onclick="openPage('wheel-orders-admin')">Wheel Coin Orders</button><button onclick="openPage('division-admin')">Division</button></nav>
